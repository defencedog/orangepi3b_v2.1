...
- All other hardware components work | RKNPU, `panfrost` WAYLAND, BT, WIFI, GPU, VPU (under `chrome` from [ppa:liujianfeng1994](https://launchpad.net/~liujianfeng1994/+archive/ubuntu/rockchip-multimedia))
...
- For `chrome` being installed using [ppa:liujianfeng1994](https://launchpad.net/~liujianfeng1994/+archive/ubuntu/rockchip-multimedia) GPU acceleration works, VPU **do not work**
